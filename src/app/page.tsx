  ...
  if (!started) {
    return (
      <div className="moving-dots min-h-screen bg-red-300 flex flex-col items-center justify-center p-4">
        ...
        <h1 className="text-3xl font-bold text-white text-stroke mb-6 leading-relaxed">
            서울대
            <br />
            동아리 
            <br />
          ...
          <button
            onClick={handleStart}
            className="px-8 py-3 bg-blue-500 text-white font-bold rounded-lg text-lg font-semibold hover:bg-blue-600 transition-colors"
          >
            START!
          </button>
          <div className="mt-4 text-sm text-gray-500">@snu.official</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="moving-dots min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-lg p-6 shadow-lg">
        <h2 className="text-xl font-semibold mb-6 bg-primary p-4 rounded-lg text-black">
          {currentQ.question}
        </h2>
